...
namespace ChurchReport.Services
{
    ...
    public class MyPayCrmService
    {
        ...
        private const int CREDIT_CARD_PAYMENT_STATUS_PAID = 100000001; //信用卡已繳費
        private const int ATM_STATUS_PAID = 100000002; //ATM轉帳/匯款已繳費
        private const int LINEPAY_STATUS_PAID = 100000006; //LinePay已繳費
            ...
            bool isSuccess)
        {
            try
            {
                ...
                if (isSuccess)
                {
                    ...
                    toolUtility.SetOptionSetAttribute(ref feeEntity, "new_pay_status", CREDIT_CARD_PAYMENT_STATUS_PAID);
                ...
                {
                    toolUtility.SetOptionSetAttribute(ref feeEntity, "new_pay_status", ATM_STATUS_PAID);
                ...
                // 步驟 6：更新描述欄位
                toolUtility.SetEntityStringAttribute(ref feeEntity, "new_description", newDescription + Environment.NewLine);
